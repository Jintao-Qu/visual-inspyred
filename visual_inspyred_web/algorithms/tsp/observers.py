...
def stats_observer(population, num_generations, num_evaluations, args):
    ...
    config.set_value("Generation", num_generations)
    config.set_value("Evaluation", num_evaluations)
    config.set_value("Worst", worst_fit)
    config.set_value("Best", best_fit)
    config.set_value("Median", med_fit)
    config.set_value("Average", avg_fit)
    config.set_value("Std_Dev", std_fit)
